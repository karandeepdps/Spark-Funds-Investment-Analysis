...
These conditions will give you sufficient information for your initial analysis. Before getting to specific questions, letÕ understand the problem and the data first.
...
3. What is Spark FundsÕbusiness objective?
...
Country analysis: Identifying the countries which have been the most heavily invested in the past. These will be Spark FundsÕfavourites as well.
Sector analysis: Understanding the distribution of investments across the eight main sectors. (Note that we are interested in the eight 'main sectors' provided in the mapping file. The two files Ñcompanies and rounds2 Ñhave numerous sub-sector names; hence, you will need to map each sub-sector to its main sector.)
